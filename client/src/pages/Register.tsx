...
import { GraduationCap, Eye, EyeOff, Loader2, AlertCircle, CheckCircle2, Clock } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-lg border-0">
          <CardHeader className="text-center pb-4">
            <div className="mx-auto h-14 w-14 rounded-2xl bg-green-100 flex items-center justify-center mb-3">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              Register to start managing your classes. Your account will need admin approval before
              you can sign in.
            </CardDescription>
          </CardHeader>
          <CardContent>
